...
- Ramas y commits: igual que el backend (`feature/SCRUM-XX-descripcion` desde `desarrollo`, `tipo(módulo): descripción SCRUM-XX`, en español). Nunca push a `desarrollo`, `preproduccion` ni `produccion`.
